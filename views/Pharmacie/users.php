            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../../router/action_page" method="post" id="form">
                        ...
                        <?php if($_SESSION['type_Name'] == 'UNIQUE'){ ?>
                            <input type="hidden" id="branch_type" name="branch_type" value="<?php echo $_SESSION['__kp_branch_type']; ?>" >
                            <input type="hidden" id="branch" name="branch" value="<?php echo $_SESSION['__kp_branch']; ?>" >
                        <?php }else{ ?>
                        <div class="mb-3">
                            <input type="hidden" id="branch_type" name="branch_type" value="<?php echo $_SESSION['__kp_branch_type']; ?>" >
                            <label for="systemRole" class="form-label">Branch </label>
