...
$data_medi_product  = $obj->getMedicalProduct();
?>
  <!-- =============================================== -->
                ...
                <table id="datatable" class="table table-striped">
                  ...
                  <tbody>
                    <?php 
                        ...
                        $n = 1;
                        foreach($data_medi_product as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="user_access?id=<?php echo $row['product_ID']; ?>" class="btn-sm btn btn-danger">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header" id="butts">
                    <h4 class="modal-title " id="myModalLabel2">New Medical Product</h4>
